-- =============================================
-- COMPREHENSIVE SHIPMENTS DATA v3.0
...
--
-- Run this AFTER loading comprehensive-sample-data-v3.sql
-- Compatible with v3.0 schema (auto-generated SKUs, all laptops assigned to clients)
-- =============================================
...
-- Laptop ID 1: DELL-XPS-9315-001 (TechCorp, delivered)
...
VALUES ('single_full_journey', 1, 1, 'delivered', 1, 'SCOP-90001', 
    ...
    'Dell XPS 13 Plus delivered to Alice Johnson. Complete lifecycle. Engineer satisfaction: Excellent.', 
    NOW() - INTERVAL '37 days', NOW() - INTERVAL '25 days');

-- Link laptop to shipment 1
INSERT INTO shipment_laptops (shipment_id, laptop_id) VALUES (1, 1);
...
VALUES (1, 1, 1, 'FDX9001234567', 7, 
    ...
    '/uploads/reception/laptop1_serial.jpg',
    '/uploads/reception/laptop1_external.jpg',
    '/uploads/reception/laptop1_working.jpg',
    'approved', 1, NOW() - INTERVAL '29 days',
    NOW() - INTERVAL '30 days', NOW() - INTERVAL '29 days');

-- Update laptop status to delivered
UPDATE laptops SET status = 'delivered', software_engineer_id = 1 WHERE id = 1;
...
-- Laptop IDs 11-15: Lenovo ThinkPad X1 Carbon Gen 10 (Innovate Solutions)
INSERT INTO shipments (shipment_type, client_company_id, software_engineer_id, status, laptop_count, jira_ticket_number, 
    courier_name, tracking_number, pickup_scheduled_date, picked_up_at, arrived_warehouse_at, 
...
INSERT INTO shipment_laptops (shipment_id, laptop_id) VALUES (2, 11), (2, 12), (2, 13), (2, 14), (2, 15);
...
VALUES 
(11, 2, 2, 'UPS9002345678', 8, NOW() - INTERVAL '2 days', 
 'Laptop 1/5: Lenovo ThinkPad X1 Carbon received. Condition: Excellent. Serial verified. All tests passed.',
 '/uploads/reception/laptop11_serial.jpg', '/uploads/reception/laptop11_external.jpg', '/uploads/reception/laptop11_working.jpg',
 'pending_approval', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
(12, 2, 2, 'UPS9002345678', 8, NOW() - INTERVAL '2 days', 
 'Laptop 2/5: Lenovo ThinkPad X1 Carbon received. Condition: Excellent. Serial verified. All tests passed.',
 '/uploads/reception/laptop12_serial.jpg', '/uploads/reception/laptop12_external.jpg', '/uploads/reception/laptop12_working.jpg',
 'pending_approval', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
(13, 2, 2, 'UPS9002345678', 8, NOW() - INTERVAL '2 days', 
 'Laptop 3/5: Lenovo ThinkPad X1 Carbon received. Condition: Excellent. Serial verified. All tests passed.',
 '/uploads/reception/laptop13_serial.jpg', '/uploads/reception/laptop13_external.jpg', '/uploads/reception/laptop13_working.jpg',
 'pending_approval', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
(14, 2, 2, 'UPS9002345678', 8, NOW() - INTERVAL '2 days', 
 'Laptop 4/5: Lenovo ThinkPad X1 Carbon received. Condition: Excellent. Serial verified. All tests passed.',
 '/uploads/reception/laptop14_serial.jpg', '/uploads/reception/laptop14_external.jpg', '/uploads/reception/laptop14_working.jpg',
 'pending_approval', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days'),
(15, 2, 2, 'UPS9002345678', 8, NOW() - INTERVAL '2 days', 
 'Laptop 5/5: Lenovo ThinkPad X1 Carbon received. Condition: Excellent. Serial verified. All tests passed.',
 '/uploads/reception/laptop15_serial.jpg', '/uploads/reception/laptop15_external.jpg', '/uploads/reception/laptop15_working.jpg',
 'pending_approval', NOW() - INTERVAL '2 days', NOW() - INTERVAL '2 days');

-- Update laptop statuses to at_warehouse
UPDATE laptops SET status = 'at_warehouse' WHERE id IN (11, 12, 13, 14, 15);

-- ============================================
-- SHIPMENT TYPE 3: WAREHOUSE TO ENGINEER (IN TRANSIT)
-- ============================================
-- Shipment 3: Warehouse inventory to engineer (in transit to engineer)
-- Laptop ID 23: HP ZBook Fury G9 (Global Tech, in transit)
INSERT INTO shipments (shipment_type, client_company_id, software_engineer_id, status, laptop_count, jira_ticket_number, 
...
UPDATE laptops SET status = 'in_transit_to_engineer', software_engineer_id = 12 WHERE id = 23;
...
-- Laptop ID 29: Dell Precision 5570 (Digital Dynamics, in transit)
INSERT INTO shipments (shipment_type, client_company_id, software_engineer_id, status, laptop_count, jira_ticket_number, 
...
INSERT INTO shipment_laptops (shipment_id, laptop_id) VALUES (4, 29);
UPDATE laptops SET status = 'in_transit_to_warehouse' WHERE id = 29;
...
-- Laptop ID 37: Apple MacBook Pro 16" M2 Pro (Cloud Ventures)
INSERT INTO shipments (shipment_type, client_company_id, software_engineer_id, status, laptop_count, jira_ticket_number, 
    courier_name, tracking_number, pickup_scheduled_date, 
    notes, created_at, updated_at) 
VALUES ('single_full_journey', 5, 21, 'pickup_from_client_scheduled', 1, 'SCOP-90005', 
    'UPS Ground', 'UPS9005678901',
...
-- Laptop ID 44: Lenovo ThinkPad P1 Gen 5 (DataDrive)
INSERT INTO shipments (shipment_type, client_company_id, software_engineer_id, status, laptop_count, jira_ticket_number, 
...
INSERT INTO shipment_laptops (shipment_id, laptop_id) VALUES (6, 44);
...
-- Laptop IDs 48-50: Dell XPS 15 9520 (NextGen Software, delivered)
INSERT INTO shipments (shipment_type, client_company_id, software_engineer_id, status, laptop_count, jira_ticket_number, 
    courier_name, tracking_number, pickup_scheduled_date, picked_up_at, arrived_warehouse_at, 
    released_warehouse_at, delivered_at, notes, created_at, updated_at) 
...
INSERT INTO shipment_laptops (shipment_id, laptop_id) VALUES (7, 48), (7, 49), (7, 50);

UPDATE laptops SET status = 'delivered' WHERE id IN (48, 49, 50);
...
INSERT INTO reception_reports (laptop_id, shipment_id, client_company_id, tracking_number, warehouse_user_id, 
    ...
    status, approved_by, approved_at, created_at, updated_at) 
VALUES 
(48, 7, 7, 'FDX9007890123', 9, NOW() - INTERVAL '40 days', 
 'Bulk 1/3: Dell XPS 15 9520 received. Excellent condition. All tests passed.',
 '/uploads/reception/laptop48_serial.jpg', '/uploads/reception/laptop48_external.jpg', '/uploads/reception/laptop48_working.jpg',
 'approved', 2, NOW() - INTERVAL '39 days', NOW() - INTERVAL '40 days', NOW() - INTERVAL '39 days'),
(49, 7, 7, 'FDX9007890123', 9, NOW() - INTERVAL '40 days', 
 'Bulk 2/3: Dell XPS 15 9520 received. Excellent condition. All tests passed.',
 '/uploads/reception/laptop49_serial.jpg', '/uploads/reception/laptop49_external.jpg', '/uploads/reception/laptop49_working.jpg',
 'approved', 2, NOW() - INTERVAL '39 days', NOW() - INTERVAL '40 days', NOW() - INTERVAL '39 days'),
(50, 7, 7, 'FDX9007890123', 9, NOW() - INTERVAL '40 days', 
 'Bulk 3/3: Dell XPS 15 9520 received. Excellent condition. All tests passed.',
 '/uploads/reception/laptop50_serial.jpg', '/uploads/reception/laptop50_external.jpg', '/uploads/reception/laptop50_working.jpg',
 'approved', 2, NOW() - INTERVAL '39 days', NOW() - INTERVAL '40 days', NOW() - INTERVAL '39 days');
...
(8, 'reception_report_created', 'reception_report', 1, NOW() - INTERVAL '2 days', '{"shipment_id":2,"laptop_id":11,"bulk":true}'),
(8, 'reception_report_created', 'reception_report', 2, NOW() - INTERVAL '2 days', '{"shipment_id":2,"laptop_id":12,"bulk":true}'),
(8, 'reception_report_created', 'reception_report', 3, NOW() - INTERVAL '2 days', '{"shipment_id":2,"laptop_id":13,"bulk":true}'),
(8, 'reception_report_created', 'reception_report', 4, NOW() - INTERVAL '2 days', '{"shipment_id":2,"laptop_id":14,"bulk":true}'),
(8, 'reception_report_created', 'reception_report', 5, NOW() - INTERVAL '2 days', '{"shipment_id":2,"laptop_id":15,"bulk":true}'),
...
(1, 'reception_report_approved', 'reception_report', 1, NOW() - INTERVAL '29 days', '{"report_id":1,"laptop_id":1,"shipment_id":1}');
...
SELECT '========================================' AS separator;
SELECT 'SHIPMENTS DATA v3.0 LOADED SUCCESSFULLY!' AS message;
SELECT '========================================' AS separator;
SELECT '' AS blank;
...
SELECT '' AS blank;
SELECT 'RECEPTION REPORTS WITH COMPLETE PHOTOS' AS section;
SELECT '--------------------------------------' AS underline;
SELECT 
    COUNT(*) FILTER (WHERE photo_serial_number IS NOT NULL AND photo_external_condition IS NOT NULL AND photo_working_condition IS NOT NULL) as complete_photos,
    COUNT(*) FILTER (WHERE photo_serial_number IS NULL OR photo_external_condition IS NULL OR photo_working_condition IS NULL) as missing_photos,
    COUNT(*) as total
...
SELECT 'All shipments have complete field data.' AS summary2;
SELECT 'All reception reports have complete photo data.' AS summary3;
SELECT 'Test the three shipment workflows in the UI.' AS summary4;
SELECT '========================================' AS separator;
